...
class HabitsAdapter :RecyclerView.Adapter<HabitsAdapter.ViewHolder>(){
    ...
    private fun setTagImage(tagChoice: String, holder: ViewHolder) {
        when(tagChoice) {
            "Lectures" -> holder.habitsImage.setImageResource(R.drawable.agenda)
            "Lap" -> holder.habitsImage.setImageResource(R.drawable.laptopuser)
            "Tutorial" -> holder.habitsImage.setImageResource(R.drawable.notebook)
            "Default-Target" -> holder.habitsImage.setImageResource(R.drawable.notebook)
            else -> {
                holder.habitsImage.setImageResource(R.drawable.agenda)
            }
        }
    }
